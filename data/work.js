...
{ id: "topcon-pascal",
  ...
  { id: "stryker-there-for-you",
    ...
    client_menu: "stryker corporate",
    client_page: "stryker corporate",
  ...
  { id: "kilburg-happy-car-buyer",
    ...
    secondary_text: ["The spots uses a sort of hall of mirrors effect. as the camera pulls back our hero Sean Del Grande is revealed to be standing in a field of flipping 3d cars which are in turn shown to be inside the DGDG website. cute huh?"],
    secondary_content: [
  ...
  { id: "opts-lpl-2013",
    ...
    secondary_text: ["The show required an extensive collection of media modules. TMG mobilized a team of freelance animators, motion graphics artists, and compositors to help us produce 22 modules in 2 weeks. Producers with opts ideas partnered with us during the creative/editorial process to help make sure that all deadlines were met. We burned the midnight oil right up to delivery, but as always, we hit the deadline. Opts and LPL Financial were thrilled with the results."],
    secondary_content: [
