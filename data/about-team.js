...
var data = [
  ...
  [ "Ryan Scott",
    ...
    ["Classically trained at The Academy of Art with a degree in Computer Art, Ryan is, at his core, a consummate generalist. Graphic design, illustration, 3D design, animation, and compositing are all very much a part his creative process. For Ryan, the challenge of orchestrating these disciplines is his specialty.  Artistically, his goal with any piece of work is to create a sincere connection with the viewer and use that connection to entertain, educate and inspire. ","Outside work, Ryan cycles, commiserates over past dojo days, and cleans up after glorious homemade meals. He shoots photos, “nerds out” over interesting devices, and delights in the wonder of his family."],
  ...
  [ "Ariella Quatra",
    ...
    [ "Adam Sturgeon",
    "Editor",
    ["ADAM GRADUATED FROM SAN FRANCISCO STATE UNIVERSITY WITH A DEGREE IN RADIO & TELEVISION. HE THEN STARTED HIS CAREER  WORKING FOR THE SAN FRANCISCO GIANTS VIDEO DEPARTMENT AND FREELANCING IN THE LIVE SPORTS BROADCASTING INDUSTRY.","IN 2006, JOINED TMG CREATIVE AS A POST-PRODUCTION TECHNICIAN, AND WORKED HIS WAY UP THE RANKS GAINING VALUABLE EXPERIENCE AND BECOMING FLUENT IN MANY OF THE DESIGN, MEDIA AND EDITING PROGRAMS THAT EXIST TODAY.","ADAM IS A VALUABLE ASSET TO TMG AS WHO CAN HANDLE MULTIPLE RESPONSIBILITIES RANGING FROM EDITING TO MOTION GRAPHICS TO DVD AUTHORING. HE’S EVEN CLIMBING THE RANKS TO PRODUCER. ADAM THOROUGHLY EXCELS WORKING DIRECTLY WITH CLIENTS AND REALLY ENJOYS CREATING WORK THAT GENERATES GREAT RESULTS.","WHEN ADAM IS NOT WORKING, HE ENJOYS SPENDING TIME WITH HIS WIFE CINDY AND THEIR TWO SONS, BLAKE AND ALEX, WHETHER IT BE AT THE LOCAL PARK, TOSSING A BASEBALL AROUND, OR THEIR ANNUAL TRIPS TO DISNEYLAND. ADAM IS ALSO AN AVID BAY AREA SPORTS FANATIC AND A PROUD 49ER SEASON TICKET HOLDER. ALONG WITH HIS FAMILY THEY WATCH OR ATTEND AS MANY GIANTS, 49ERS, WARRIORS AND SHARKS GAMES AS POSSIBLE. ADAM ALSO TRIES TO SQUEEZE IN TIME POLISHING HIS SKILLS ON THE GOLF LINKS OR GOING TO CONCERTS TO SEE HIS FAVORITE BANDS."],
  ...
  [ "Bryant Coffey",
    "Facility Technician",
    ["To say Bryant has a great eye is an understatement. First and foremost a photographer, Bryant also earned his bachelor's degree in visual effects and motion graphics at the Art Institute of Colorado. After graduation he went straight to California where TMG Creative grabbed him.","Bryant brings all these talents to his work as a video editor and motion graphics artist, working on a wide variety of projects ranging from 3D animation and motion graphics to video editorial and website creation.","But his talents don't stop there. He's an excellent problem solver and works closely with operations to lend his technical abilities.","It's safe to say that Bryant, in fact, has two great eyes. One for great creative and the other: always on the ball. Some guys have everything.  Be sure to stop by and check out his photography <a href='http://www.etsy.com/shop/bcoffeyphotography'>here!</a>"],
