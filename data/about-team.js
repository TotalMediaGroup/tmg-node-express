...
var data = [
  ...
  [ "JACK HSU",
    ...
    ["JACK’s the guy that keeps things running.  He BEGAN FREELANCING FOR TMG AS CHIEF ENGINEER IN THE EARLY ‘90s.  HE REPAIRED AND MAINTAINED ANYTHING FROM MAC AND WINDOWS COMPUTERS TO BROADCAST VTRS AND ALL TYPES OF VIDEO EDITING AND GRAPHICS SYSTEMS.  HE DESIGNED AND ENGINEERED COMPLETE SYSTEMS.  ","","HE, ALONG WITH ALDO PANATTONI, FOUNDER, WAS AWARDED A PATENT FOR A NEW SYSTEM TO CREATE INSTANT VIDEO DUBS ON LOCATION.  IN 1999, JACK LEFT TMG TO DESIGN AND BUILD A BRAND NEW FACILITY FROM GROUND UP IN TEXAS  BUT JACK REALIZED HE MISSED HIS HOME AT TMG, AND IN 2004 WAS WELCOMED BACK WITH OPEN ARMS.  TMG HAS NEVER LOOKED OR RUN BETTER.  ","","JACK ENJOYS WORKING AROUND THE HOUSE and STUDYING SCRIPTURES.  He travels to Mexico to lend his talents to orphanages, helping with water projects and infrastructure.  ","","Jack’s a BIG FAN OF FIVE GUYS."],
